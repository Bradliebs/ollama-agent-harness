/**
 * researchReport.ts — research report renderer (compiled).
 *
 * Pure composition: renders a structured `ResearchInput` into a polished,
 * self-contained HTML report plus a Markdown summary. The gathering step
 * (web search, page reads, model analysis) is the caller's job.
 *
 ...
 * `cookbook/blueprint-competitor-research.ts` re-exports from here and adds
