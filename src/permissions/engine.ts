...
const READ_TOOLS = new Set(['file_read', 'list_files', 'list_uploads', 'grep', 'glob', 'web_fetch', 'web_search', 'web_read', 'image_analyze', 'pdf_read', 'pdf_metadata', 'pdf_extract_tables', 'rag_search', 'rag_list_indexes']);
