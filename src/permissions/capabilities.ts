...
export const CAPABILITY_POLICIES: CapabilityPolicy[] = [
  ...
  },
  {
    ...
    posture: 'gated',
    summary: 'Email and Telegram notification tools are available through email_draft, email_send, and telegram_notify with settings-backed delivery.',
    readiness: 'email_draft creates local .eml files; email_send and telegram_notify are disabled by default and gated by permissions.',
    existingCoverage: ['email_draft', 'email_send', 'telegram_notify', 'output validation', 'permission prompts'],
